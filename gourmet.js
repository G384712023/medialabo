...
for(let i = 0; i < 6; i++){
  ...
  if(i == 0){
    num11.textContent = 'ジャンル:' + data.results.shop[0].genre.name ;	
  }
  if(i == 1){
    num11.textContent = 'サブジャンル:' + data.results.shop[0].sub_genre.name ;	
  }
  if(i == 2){
    num11.textContent = 'アクセス:' + data.results.shop[0].access ;	
  }
  if(i == 3){
    num11.textContent = '最寄駅:' + data.results.shop[0].station_name ;	
  }
  if(i == 4){
    num11.textContent = '住所:' + data.results.shop[0].address ;	
  }
  if(i == 5){
    num11.textContent = '予算:' + data.results.shop[0].budget.name ;	
  }
...
tr2.appendChild(th1);
th1.appendChild(document.createTextNode(data.results.shop[0].open));
...
for(let i = 0; i < 6; i++){
  ...
  if(i == 0){
    num25.textContent = 'ジャンル:' + data.results.shop[1].genre.name ;	
  }
  if(i == 1){
    num25.textContent = 'サブジャンル:' + data.results.shop[1].sub_genre.name ;	
  }
  if(i == 2){
    num25.textContent = 'アクセス:' + data.results.shop[1].access ;	
  }
  if(i == 3){
    num25.textContent = '最寄駅:' + data.results.shop[1].station_name ;	
  }
  if(i == 4){
    num25.textContent = '住所:' + data.results.shop[1].address ;	
  }
  if(i == 5){
    num25.textContent = '予算:' + data.results.shop[1].budget.name ;	
  }
...
tr4.appendChild(th2);
th2.appendChild(document.createTextNode(data.results.shop[1].open));
